...
class Fuzzy:
	...
	@classmethod
	def fuzzify(cls, budget):
		ret = {'Very Low': 0, 'Low': 0, 'Medium': 0, 'High': 0, 'Very High': 0}
		if budget < 300:
			ret['Very Low'] = 1.0
		elif 300 <= budget < 400:
			ret['Very Low'] = 1.0
	...
	@classmethod
	def fuzzify_over_n(cls, budget, guests):
		budget /= guests
		CONST = 39
		cf = {'Very Low': 0, 'Low': 0, 'Medium': 0, 'High': 0, 'Very High': 0}
		if budget < 300/CONST:
			cf['Very Low'] = 1.0
